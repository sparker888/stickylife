...
const collections = [
  {
    name: "Zoltron",
    href: '/page-3',
    imageSrc: 'https://res.cloudinary.com/gravital-digital/image/upload/v1648493943/zoltron_otsjei.jpg',
    imageAlt: 'Sticker Artist Zoltron',
  },
  {
    name: "TY",
    href: '#',
          ...
          <div className="relative max-w-3xl mx-auto pb-96 px-4 text-center sm:pb-0 sm:px-6 lg:px-8">
            ...
            <div className="relative py-32">
              ...
              <div className="mt-4 sm:mt-6">
                <a
                  href="#"
                  className="inline-block bg-orange-600 border border-transparent rounded-md py-3 px-8 font-medium text-white hover:bg-cyan-500"
                >
        ...
        <section
          ...
          >
            <div className="max-w-2xl mx-auto lg:max-w-none">
              <h2 id="testimonial-heading" className="text-2xl font-extrabold tracking-tight text-cyan-900">
              ...
              <div className="mt-12 md:mt-0 md:row-start-2 md:col-start-3 md:col-span-8 lg:row-start-1 lg:col-start-9 lg:col-span-4">
                ...
                <form className="mt-2 flex sm:max-w-md">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    required
                    className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md shadow-sm py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:border-orange-600 focus:ring-1 focus:ring-purple-400"
                  />
                  <div className="ml-4 flex-shrink-0">
                    <button
                      type="submit"
                      className="w-full bg-cyan-500 border border-transparent rounded-md shadow-sm py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                      Sign up
                    </button>
                  </div>
